                ...
                <h1 className="form-title">Education</h1>
                    <form>
                        <div className="form-group">
                            ...
                            <input type="text" class="form-control" id="prevEmployerInput" placeholder="ex. Bachelor's of Science in Computer Science"/>
                            <label for="jobTitleInput" className="txtInput-heading">University/College</label>
                            <input type="text" class="form-control" id="jobTitleInput" placeholder="ex. The University of Texas at Austin"/>
                            <div className="row">
                                <div className="col-md-2">
                                    <label for="exampleFormControlSelect1" className="txtInput-heading">Start Year</label>
                                    <select class="form-control month-dropdown" id="exampleFormControlSelect1">
                                        <option>- Year -</option>
                                        <option>2000</option>
                                        <option>2001</option>
                                        <option>2002</option>
